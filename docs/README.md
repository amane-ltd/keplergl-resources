...
本ドキュメントは、[Kepler.gl](https://kepler.gl/)で利用可能なリソースカタログです。

---

## コンテンツ

- [スターターマップ詳細](samplemaps.md) - 完成済みのカスタムマップURL
- [ベースマップ詳細](basemaps.md) — 地理院地図ベースのマップスタイル
- [ベクタータイル詳細](vector-tiles.md) — 鉄道・バス・人口統計・都市計画などのベクタータイル
- [地域公共交通のアップデートの実践](howtouse.md) - 国土交通省「地域公共交通計画の『アップデートガイダンス Ver1.0』」に対応したKepler.glマップの活用方法
- [ベクタータイルの前処理方法](howtotranspose.md) - ベクタータイルのデータ前処理とフォーマット変換手順
- [3Dモデルの追加](3dmodel.md) - Kepler.glで3Dモデルを表示するための設定と活用方法 
...
| 名称 | 配布元 | ライセンス | URL |
|------|--------|-----------|-----|
| 全国スターターマップ | [株式会社AMANE](https://amane.ltd/) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | `https://raw.githubusercontent.com/amane-ltd/keplergl-resources/refs/heads/main/samplemaps/samplemap.json` |
| レクチャー用スターターマップ | [株式会社AMANE](https://amane.ltd/) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | `https://raw.githubusercontent.com/amane-ltd/keplergl-resources/refs/heads/main/samplemaps/lecturemap.json` |
...
| 名称 | 配布元 | ライセンス | URL |
|------|--------|-----------|-----|
| ⭐︎鉄道駅 | [株式会社AMANE](https://amane.ltd/) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | `https://d1ea95yc41zb9r.cloudfront.net/pmtiles/jpn_kokudo__rail_station_info_pmt.pmtiles`|
| ⭐︎鉄道路線 | [株式会社AMANE](https://amane.ltd/) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | `https://d1ea95yc41zb9r.cloudfront.net/pmtiles/jpn_kokudo__rail_line_pmt.pmtiles` |
...
|---|---|
| 名称 | 株式会社AMANE |
| 所在地 | 東京都港区芝大門一丁目2番14号 |
| Web | [https://amane.ltd/](https://amane.ltd/) |
| お問い合わせ | [https://amane.ltd/contact/](https://amane.ltd/contact/) |

## ライセンス

本リソースは、特に記載がない限り [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) のもとで提供されています。

一部データは第三者により提供されています。詳細は各リソースの一覧ページをご確認ください。
